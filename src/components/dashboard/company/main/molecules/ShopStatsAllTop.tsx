...
export default function ShopStatsAllTop() {
  return (
      ...
      <ul className="flex-1 flex flex-col h-full">
        {Array.from({ length: 5 }).map((item, i) => (
          ...
          >
            ...
            <div className="flex-1 flex items-center font-bold">{"상품명"}</div>
            <div className="flex items-center justify-center w-[120px] text-gray-500">
              {"13개"}
            </div>
          </li>
        ))}
